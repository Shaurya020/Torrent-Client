...
module.exports.size = torrent =>{
    ...
    const size = torrent.info.files ? torrent.info.files.map(files=>files.length).reduce((a,b)=> a+b): torrent.info.length;    //Used because file info may contain info about many files so adding all the file sizes if multiples files
