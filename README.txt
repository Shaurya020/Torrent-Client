...
4. There is scope for improvement that we have recognised and are planning to work on in the future like:
	 a) automate process of iteration over index of announce list(urls) 
	 b) download speed can be improved by improving the algorithm to request pieces(need more time for it)
