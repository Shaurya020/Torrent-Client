//this module is used to build all 10 types of messages + the handshake message requireed to establish TCP Connection with the peer & transfer of pieces.
'use strict';
...
module.exports.buildBitfield = bitfield => {
  // console.log("build bitfield called")
